...
const STATUS_STYLES: Record<string, { ring: string; text: string; loading?: boolean }> = {
  ...
  starting: { ring: "border-warning-solid animate-pulse", text: "text-warning" },
  restarting: { ring: "border-warning-solid animate-pulse", text: "text-warning" },
  building: { ring: "border-info-solid animate-pulse", text: "text-info" },
  deploying: { ring: "border-info-solid animate-pulse", text: "text-info" },
  built: { ring: "border-muted-foreground/40", text: "text-muted-foreground" },
